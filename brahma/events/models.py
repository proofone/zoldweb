...
class EventSession(models.Model):
    RECORDING_CHOICES = [("none", "Nem fontos"), ("video", "Videó"), ("audio", "Csak hang")]
    ...
    cam_operator = models.ForeignKey(User, verbose_name=_("Camera operator"), on_delete=models.SET_NULL, blank=True, null=True)
    rec_needed = models.CharField(choices=RECORDING_CHOICES, verbose_name=_("Recording needed"), max_length=45, blank=True, null=True)
